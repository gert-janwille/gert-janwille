...
const PrivacyPolicy = () => (
  <main className="pp-container">
    <section>
      ...
      <p>Gert-Jan Wille Privacy Policy</p>
      <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from gert-janwille.com / gert-janwille.be (the “Site”).</p>

      <p className="caption">PERSONAL INFORMATION WE COLLECT</p>
      ...
      <p className="caption">GOOGLE ANALYTICS</p>
      ...
      <p className="caption">HOW DO WE USE YOUR PERSONAL INFORMATION?</p>
      ...
      <p className="caption">SHARING YOUR PERSONAL INFORMATION</p>
      ...
      <p className="caption">DATA RETENTION</p>
      ...
      <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:hello@gert-janwille.com">hello@gert-janwille.com</a>.</p>
